  ...
  <div id="app">
    ...
    <div id="questions">
      ...
      <v-row justify="center">
        <v-expansion-panels popout>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>Ayuda, no sé como generar la clave derivada!</v-expansion-panel-header>
            <v-expansion-panel-content>
              <p>En la pregunta "¿Puedo generar la clave por mis propios medios y consultarla en esta aplicación?"</p>
              <br /><p>se le brinda una página que puede descargar y le permite generar la clave derivada sin internet en cualquier dispositivo que soporte javascript. Pero si aún así lo encuentra complicado y confía en este sitio, al introducir el número de tarjeta en el cuadro de edición siguiente la clave será generada automáticamente para usted</p><br />
              <form>
    ...
    <div id="form">
      ...
      <form>
        ...
        ></v-text-field>
        <v-btn :disabled="scryptedCard==''" @click="checkKey">Verificar clave</v-btn>
      </form>
    </div>
    ...
    <div id="result" v-show="this.checkedKey != ''">
      ...
      <p>{{checkedKey}}</p>
      <br />
      <p>Resultado {{result?"positivo":"negativo"}}. La clave proporcionada {{result?"":"no"}} se encuentra en la base de datos</p><br />
      <p v-if="result">Dado que su tarjeta se encuentra en la lista, lo más recomendable es que solicite el remplazo de su tarjeta con su banco. De lo contrario se expone a diversas estafas</p>
    </div>
